...
@click.option('--cpus', default=1, help='number of CPU cores to use in parallel. -1 means "use all system"')
...
def main(image_to_check, cpus, model, upsample):
    if (sys.version_info < (3, 4)) and cpus != 1:
        click.echo(
            "WARNING: Multi-processing support requires Python 3.4 or higher. Falling back to single-threaded processing.")
        cpus = 1
